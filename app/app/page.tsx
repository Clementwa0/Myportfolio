...
export default function Home() {
  ...
  const topSkills = [
    skills.find(skill => skill.category === 'programming' ),
    skills.find(skill => skill.category === 'networking' ),
    skills.find(skill => skill.category === 'cybersecurity'),
    skills.find(skill => skill.category === 'tools'),
  ].filter(Boolean);
