        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              Junior Software Developer based in Nairobi, Kenya, 
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:clementwa01@gmail.com" aria-label="Email">
                <Mail className="h-5 w-5 text-muted-foreground hover:text-primary transition-colors" />
              </a>
              <a href="tel:+254115062024" aria-label="Phone">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">clementwa01@gmail.com</span>
              </li>
              <li className="flex items-center gap-2">
                <PhoneCall className="h-4 w-4 text-muted-foreground" />
                <span className="text-muted-foreground">+254 115 062 024</span>
              </li>
