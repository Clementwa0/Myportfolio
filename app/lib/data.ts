...
export const projects: Project[] = [
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/6956800/pexels-photo-6956800.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  ...
  },
  {
    ...
    description: 'A tool for monitoring network performance and detecting potential security threats.',
    tags: ['Python', 'Flask', 'Socket.IO', 'Chart.js'],
...
export const certifications:Certification[]  = [
  {
    ...
    date: '2023',
    url: 'https://www.coursera.org/account/accomplishments/specialization/certificate-link-here', // Optional
  },
];
...
export const experiences :Experience[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Integrated REST APIs and deployed apps using Firebase and Vercel.',
