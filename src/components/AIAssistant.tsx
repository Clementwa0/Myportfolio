...
const AIAssistant: React.FC<AIAssistantProps> = ({ isOpen, onToggle }) => {
      ...
      text: (
        <div className="space-y-3">
          <p className="font-medium">
            👋 Hello! I'm Muli's AI assistant. Here's how I can help:
          </p>
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className="flex items-center p-2 bg-slate-800 hover:bg-purple-700 rounded-lg transition-colors text-sm"
            >
              <Database className="w-4 h-4 mr-2" /> Tech Skills
            </button>
            <button
          ...
          <p className="text-xs text-purple-300 pt-2">
            Try asking: "Tell me about Muli's education"
          </p>
        </div>
      ),
      sender: "ai",
  ...
  const formatProject = (
    ...
    <div className="mb-3 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
      ...
      <div className="mt-2 flex space-x-2 text-xs">{links}</div>
    </div>
  );

  const generateResponse = (userInput: string): React.ReactNode => {
      ...
      projects: (
        <div>
          <p className="font-medium mb-3 flex items-center">
            <Code className="w-5 h-5 mr-2" /> Muli's Featured Projects
          </p>
          {formatProject(
            "Job Tracker Web App",
            ...
            <>
              ...
              <span className="bg-slate-700/50 px-2 py-1 rounded">GitHub</span>
            </>
          )}
          {formatProject(
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            ...
            <div className="p-2 bg-slate-800/50 rounded-lg">
              ...
              <p className="text-sm">
                Node.js, Express, REST APIs, PHP, Laravel
              </p>
            </div>
            <div className="p-2 bg-slate-800/50 rounded-lg">
            ...
            <div className="p-2 bg-slate-800/50 rounded-lg">
              <p className="font-semibold text-purple-400">DevOps</p>
              <p className="text-sm">Git, GitHub Actions, Vercel, Netlify</p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="p-3 bg-slate-800/50 rounded-lg mb-3 border border-slate-700">
            <p className="font-semibold text-purple-400">
              IT Support Attaché | Teachers Service Commission
            </p>
            <p className="text-sm text-gray-300">
              May 2023 - July 2023 | Kenya
            </p>
            <ul className="mt-2 text-sm list-disc pl-5 space-y-1">
              <li>
                Provided IT support to 25+ users, resolving 95% of issues on
                first contact
              </li>
          ...
          <p className="text-sm bg-slate-800/50 p-2 rounded-lg border border-slate-700">
            Currently pursuing Full-Stack Web Development certification at Power
            Learn Project Academy
          </p>
        </div>
      ),
      contact: (
        <div>
          ...
          <p className="mt-3 text-sm text-center text-purple-300 bg-slate-900/50 p-2 rounded-lg">
            Based in Masi, Kenya | Open to remote opportunities
          </p>
        </div>
      ),
      education: (
        <div>
          ...
          <div className="p-3 bg-slate-800/50 rounded-lg mb-3 border border-slate-700">
            ...
            <p className="text-sm text-gray-300">
              South Eastern Kenya University | 2020-2024
            </p>
            <p className="mt-2 text-sm">
              Graduated with Second Class Upper Division
            </p>
            <p className="text-sm mt-2 font-medium">Relevant Coursework:</p>
          ...
          <div className="p-3 bg-slate-800/50 rounded-lg border border-slate-700">
            ...
            <p className="text-sm text-gray-300">
              Power Learn Project Academy | 2024-Present
            </p>
            <p className="mt-2 text-sm">
              Hands-on training in modern web development:
            </p>
            <ul className="text-sm list-disc pl-5 mt-1">
              <li>React & TypeScript</li>
              <li>Node.js & Express</li>
              <li>MongoDB & REST APIs</li>
              <li>Professional project development</li>
            </ul>
          </div>
        </div>
      ),
    ...
    if (lowercaseInput.includes("hire") || lowercaseInput.includes("recruit")) {
      return (
        <div className="bg-purple-900/20 p-4 rounded-lg border border-purple-700">
          <p className="font-medium mb-2">🚀 Hiring Opportunity!</p>
          <p>
            Muli is actively seeking software development opportunities with:
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>Full-stack development roles</li>
            <li>Frontend engineering positions</li>
            <li>Software engineering internships</li>
          </ul>
          <p className="mt-3">
            Contact him at{" "}
            <span className="text-purple-400">clementwa01@gmail.com</span>
          </p>
        </div>
      );
    }
    ...
    return (
      <div className="space-y-3">
        ...
        <p className="text-sm text-purple-300">
          Try asking: "What certifications does Muli have?"
        </p>
      </div>
    );
  };
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-96 max-w-[90vw] h-[31rem] bg-slate-900/95 backdrop-blur-md border border-slate-700/50 rounded-2xl shadow-2xl z-40 flex flex-col"
          >
            {/* Header */}
